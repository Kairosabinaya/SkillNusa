        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#010042] focus:border-[#010042] focus:z-10 sm:text-sm"
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className={`relative flex items-center justify-center px-4 py-3 rounded-lg border ${role === 'freelancer' ? 'bg-[#010042]/5 border-[#010042]' : 'border-gray-300'} cursor-pointer hover:border-[#010042] transition-all`}>
                  <input
                    type="radio"
                    name="role"
                    value="freelancer"
                  ...
                  />
                  <span className={`text-sm font-medium ${role === 'freelancer' ? 'text-[#010042]' : 'text-gray-700'}`}>Freelancer</span>
                  {role === 'freelancer' && (
              ...
              <div>
                <label className={`relative flex items-center justify-center px-4 py-3 rounded-lg border ${role === 'client' ? 'bg-[#010042]/5 border-[#010042]' : 'border-gray-300'} cursor-pointer hover:border-[#010042] transition-all`}>
                  <input
                    type="radio"
                    name="role"
                    value="client"
                  ...
                  />
                  <span className={`text-sm font-medium ${role === 'client' ? 'text-[#010042]' : 'text-gray-700'}`}>Client</span>
                  {role === 'client' && (
                    <svg className="h-5 w-5 text-[#010042] absolute top-2 right-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>

...
export default function Login() {
  ...
  const handleEmailOrUsernameChange = (e) => {
    ...
    // Izinkan semua karakter yang valid untuk email atau username
    // Karakter email: a-z, 0-9, @, ., _, +, -
    // Karakter username: a-z, 0-9
    // Gabungkan keduanya untuk fleksibilitas input

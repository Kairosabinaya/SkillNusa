...
export default function Login() {
  ...
  const handleEmailOrUsernameChange = (e) => {
    ...
    if (rawValue.includes('@')) {
      // Format untuk email: huruf kecil, angka, dan semua karakter email yang valid
      // Termasuk: huruf, angka, titik (.), tanda hubung (-), underscore (_), plus (+)
    ...
    <div className="min-h-screen bg-gray-50 py-12 relative">
      ...
      <PageContainer maxWidth="max-w-md" padding="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center min-h-[calc(100vh-6rem)]">
          <div className="w-full space-y-8 bg-white p-8 rounded-xl shadow-md relative z-10">
            <div>

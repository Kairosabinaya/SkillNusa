          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row md:items-end">
              ...
              <div className="flex-1">
                ...
                <div className="inline-block px-3 py-1 rounded-full bg-[#010042]/10 text-[#010042] text-sm font-medium mb-4">
                  {combinedUserData?.activeRole === 'freelancer' ? 'Freelancer' : 
                   combinedUserData?.activeRole === 'admin' ? 'Admin' : 'Client'}
                </div>
                
                <div className="flex flex-wrap gap-2 mt-4">
                  {/* Tombol Edit Profil dan Hapus Akun */}
                  {!isEditing && (
                    <>
                      <button
                        type="button"
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                {(combinedUserData?.roles?.includes('client') || !isFreelancer) && combinedUserData?.companyName && (
                  <div className="mt-6">
